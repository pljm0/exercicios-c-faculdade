...
main() {
	...
	if(parcelas == 0 || parcelas == 1) {
		printf("O valor da venda parcelado em %d vezes e de: %.2f", parcelas, ((valor*5/100)-valor)*-1);
		
	}else if(parcelas == 2 || parcelas == 3) {
		printf("O valor da venda parcelado em %d vezes e de: %.2f", parcelas, (valor*5/100)+valor);
		
	}else {
		printf("O valor da venda parcelado em %d vezes e de: %.2f", parcelas, (valor*10/100)+valor);
